...
/** An Utterance is used to transmit information between servers,
 * including the semantic meaning, the dialogue act, the speaker, and
 * the listener(s). This is the only NLP-specific class that is
 * used by servers outside of NLP. */
